...
e&&e.getTransaction()&&e.setSpan(void 0)}},43174:(t,e,n)=>{n.r(e),n.d(e,{BROWSER_TRACING_INTEGRATION_ID:()=>st,BrowserTracing:()=>ot,IdleTransaction:()=>k.io,Integrations:()=>i,Span:()=>dt.Dr,SpanStatus:()=>_t,TRACEPARENT_REGEXP:()=>x.K,Transaction:()=>pt.Y,addExtensionMethods:()=>a.ro,defaultRequestInstrumentationOptions:()=>nt,extractTraceparentData:()=>x.q,getActiveTransaction:()=>Y.x1,hasTracingEnabled:()=>Y.zu,instrumentOutgoingRequests:()=>it,spanStatusfromHttpCode:()=>dt.Zd,startIdleTransaction:()=>a.lb,stripUrlQueryAndFragment:()=>o.rt})
var i={}
n.r(i),n.d(i,{Apollo:()=>N,BrowserTracing:()=>ot,Express:()=>d,GraphQL:()=>R,Mongo:()=>S,Mysql:()=>T,Postgres:()=>f,Prisma:()=>y})
...
var D=n(7209)
class N{constructor(){N.prototype.__init.call(this)}static __initStatic(){this.id="Apollo"}__init(){this.name=N.id}setupOnce(t,e){var n=(0,m.$y)("apollo-server-core")
...
var l=t.call(this,...d)
return(0,_.J8)(l)?l.then((t=>((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),l)}}))}(t,n,i,e)}))})),t))),t.call(this)}})):("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.error("Apollo Integration was unable to require apollo-server-core package.")}}N.__initStatic()
var x=n(75492),b=n(22850),B=n(66627),G=n(68256),k=n(27448),Y=n(48206),U=(0,B.R)(),A=n(4549),I=n(88468),C=(t,e,n)=>{let i
...
t.args[1]=t.args[1]||{}
var o=t.args[1]
o.headers=function(t,e,n,i){var a=(0,b.IQ)(e),s=n.toTraceparent(),r="undefined"!=typeof Request&&(0,_.V9)(t,Request)?t.headers:i.headers
if(r){if("undefined"!=typeof Headers&&(0,_.V9)(r,Headers))return(o=new Headers(r)).append("sentry-trace",s),a&&o.append(b.bU,a),o
if(Array.isArray(r)){var o=[...r,["sentry-trace",s]]
return a&&o.push([b.bU,a]),o}var c="baggage"in r?r.baggage:void 0,d=[]
...
var o=s.getDynamicSamplingContext(),c=(0,b.IQ)(o)
c&&t.xhr.setRequestHeader(b.bU,c),s.metadata.propagations+=1}catch(t){}}}}}(t,o,c)}))}var at=(0,B.R)(),st="BrowserTracing",rt={idleTimeout:k.nT,finalTimeout:k.mg,markBackgroundTransactions:!0,routingInstrumentation:function(t){let e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
...
var s="pageload"===t.op,o=s?ct("sentry-trace"):null,c=s?ct("baggage"):null,_=o?(0,x.q)(o):void 0,d=c?(0,b.EN)(c):void 0,p={...t,..._,metadata:{...t.metadata,dynamicSamplingContext:_&&!d?{}:d},trimEnd:!0},l="function"==typeof e?e(p):p,u=void 0===l?{...p,sampled:!1}:l
...
var g=(0,a.lb)(h,u,n,i,!0,{location:m})
...
var i=n(4549),a=n(33867),s=n(88468),r=n(88521),o=n(15834),c=n(20484)
...
//# sourceMappingURL=chunk.174.e997dfffceeaa0ce4636.map